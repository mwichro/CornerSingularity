...
\begin{proof}
    ...
    $|w\,D_1|\le \tfrac12 d_\phi w^2 + \tfrac1{2d_\phi}D_1^2$, and $D_1^2\le c_\phi^2 J_0^2/|\log J_0|\le d_\phi J_0$
    once $J_0$ is small (the factor $J_0/|\log J_0|\to0$). Hence $\tfrac1{2d_\phi}D_1^2\le\tfrac12 J_0$ and
