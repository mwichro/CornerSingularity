...
\begin{remark}[Status of the subcritical signs: geometry-decided, checked numerically]
    ...
    rather than an inheritance from flat creasing. We do not sign $b_\psi,d_\psi$ analytically; they are evaluated
...
flat surface --- whose apparent tangent catastrophe is, on every physical branch, regularised by the barrier-forced
kinematic relief. That the phenomenon first surfaced as ill-conditioning in a numerical computation is incidental to its
