...
\begin{remark}[Status of the subcritical signs: geometry-decided, checked numerically]
    ...
    rather than an inheritance from flat creasing. We do not sign $b_\psi,d_\psi$ analytically; they are read off directly
    from the finite-element eigenmode and reduced operator of the cut-FEM study \cite{cutfemAD}, the proper arbiter of a
