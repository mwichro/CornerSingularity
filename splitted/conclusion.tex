...
its critical value $-1$ at every tested resolution, with the smallest margin near the incompressible corner --- so the
cubic clause of subcriticality is numerically supported, though on a surrogate cell whose refinement behaviour is not
yet settled; the quintic clause $d>0$ remains untested. What remains genuinely beyond reach here is
