...
As a byproduct, the same critical mode furnishes the asymptotic-rotation check of Assumption~\ref{ass:rot}
...
against the shear term, not by the $f''$ term alone --- the honest mechanism behind the relief estimate.
