...
\end{itemize}
The sign is substantiated rather than merely reported. The diagnostic ratio $r:=b_{\mathrm{fb}}/b_{\mathrm{E_4}}$ is
\emph{normalisation-invariant} (both terms scale as $\|\bm\phi\|^4$) and decides the sign by $b<0\iff r<-1$. It is
...
crease-analogue. The computation is reproduced by \texttt{graded\_buckling.py}, which reuses the validated linear
