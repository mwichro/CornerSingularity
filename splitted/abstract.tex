...
loading direction and the volumetric energy penalty. In tension, a mildly growing volumetric penalty yields a benign
singularity where the tangent operator remains strongly elliptic and Fredholm: the standard Kondratiev edge exponents
of linear elasticity govern the mesh-relevant intermediate scales, while at the vertex itself the extreme stretch
screens the volumetric coupling and the increments are regular. Under compression, the local volume contraction
drives an algebraic blow-up of the operator norm. We show
that this breakdown is a structural bifurcation rather than a material loss of ellipticity. Using a tangent-cone
blow-up reduction, we reduce the ordering between the localised surface creasing instability and pointwise material
collapse to a single computable tip-disc criterion, under which creasing preempts collapse. An
