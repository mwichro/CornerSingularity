...
rather than by analogy (Remark~\ref{rem:bsign}).
...
\begin{enumerate}
    ...
    \item \emph{Subcritical sign pattern}, $b<0<d$ (Assumption~\ref{ass:subcrit}): the directions in which the cubic and
          ...
          the frozen terms; we evaluate the feedback-corrected coefficients numerically (Remark~\ref{rem:bsign}).
\end{enumerate}
...
\begin{table}[t]
    ...
    \begin{tabular}{lll}
        ...
        Subcriticality $b<0<d$ (Ass.~\ref{ass:subcrit})              & assumed             & \emph{numerical}; frozen parts adverse (Lem.~\ref{lem:volcoeff}) \\
        \bottomrule
    \end{tabular}
