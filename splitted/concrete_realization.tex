...
\begin{enumerate}
    ...
    \item \emph{Subcritical sign pattern}, $b<0<d$ (Assumption~\ref{ass:subcrit}): the directions in which the cubic and
          ...
          quintic clause $d>0$, by contrast, has no analogous sign theorem and no computation behind it and remains
          fully open (Remark~\ref{rem:fbstatus}). The
...
\begin{table}[t]
    ...
    \begin{tabular}{lll}
        ...
        Subcriticality $b<0<d$ (Ass.~\ref{ass:subcrit})                           & assumed                                                        & cubic: sign \textbf{proved} $b_\psi{\le}0$ (Lem.~\ref{lem:fbsign}), magnitude \emph{certified numerically} (Cor.~\ref{cor:cert}, \S\ref{sub:numb}); quintic $d{>}0$ \emph{open} (Rem.~\ref{rem:fbstatus})     \\
        \bottomrule
    \end{tabular}
