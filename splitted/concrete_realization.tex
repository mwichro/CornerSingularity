...
\begin{proposition}[Collapse, if anywhere, is confined to the tip disc]
    ...
    Proposition~\ref{prop:blowup}(i) hold with pointwise gradient control of the remainder,
    $|\Grad\bm u_0^\sharp|\le C_\sharp(t)\,(r/\rho)^{\alpha'-1}$ \cite{KMR2001,MazyaRossmann2010}, and set
